  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        手机号：<span>{{orderInfo.phoneNum}}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <a class="subBtn" @click="submitOrder">提交订单</a>a
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      async submitOrder(){
        ...
        let data = {
            "consignee": this.userDafAdd.consignee,
            "consigneeTel": this.userDafAdd.phoneNum,
            "deliveryAddress": this.userDafAdd.fullAddress,
            "paymentWay": "ONLINE",
