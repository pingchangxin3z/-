  ...
  <div class="cart">
      ...
      <div class="cart-body">
        ...
        >
          <li class="cart-list-con1">
            ...
            @change="updateCheckes(cart,$event)"
            >
          </li>
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isCheckedAll&&cartInfoList.length>0"
...
import throttle from 'lodash/throttle'
  export default {  
    ...
    methods: {
      ...
      deleteCartList: throttle(async function(cart){
        try {
